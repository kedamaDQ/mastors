...
mod tests {
    ...
    fn inject_json() {
        let json = r#"
        {
            ...
            "username":"kedama",
            "acct":"kedama",
            "display_name":"よぅ :c_anlucea: :e_angel:",
            "locked":false,
            "bot":false,
            "discoverable":true,
            "group":false,
            "created_at":"2017-06-27T10:39:39.991Z",
            "note":"note",
            "url":"https://foresdon.jp/@kedama",
            "avatar":"https://media.foresdon.jp/accounts/avatars/000/000/001/original/7fd2f534546320d1.png",
            "avatar_static":"https://media.foresdon.jp/accounts/avatars/000/000/001/original/7fd2f534546320d1.png",
            "header":"https://media.foresdon.jp/accounts/headers/000/000/001/original/af2726d336273b4a.png",
            "header_static":"https://media.foresdon.jp/accounts/headers/000/000/001/original/af2726d336273b4a.png",
            "followers_count":338,
            "following_count":370,
            "statuses_count":49624,
            "last_status_at":"2020-03-01",
            "emojis":[
                {
                    "shortcode":"c_anlucea",
                    "url":"https://media.foresdon.jp/custom_emojis/images/000/014/277/original/b07badd3727f73d3.png",
                    "static_url":"https://media.foresdon.jp/custom_emojis/images/000/014/277/static/b07badd3727f73d3.png",
                    "visible_in_picker":true
                },
                {
                    "shortcode":"e_angel",
                    "url":"https://media.foresdon.jp/custom_emojis/images/000/001/146/original/fde_angel.png",
                    "static_url":"https://media.foresdon.jp/custom_emojis/images/000/001/146/static/fde_angel.png",
                    "visible_in_picker":true
                },
                {
                    "shortcode":"m_slime",
                    "url":"https://media.foresdon.jp/custom_emojis/images/000/000/001/original/fdm_slime.png",
                    "static_url":"https://media.foresdon.jp/custom_emojis/images/000/000/001/static/fdm_slime.png",
                    "visible_in_picker":true
                }
            ],
            "fields":[
        ...
        let account = match Account::from_json(json.to_owned()) {
            Ok(acc) => acc,
            Err(e) => panic!("{:#?}", e),
        };

        assert_eq!("kedama", account.username);
        assert_eq!(Utc.ymd(2017, 6, 27).and_hms_milli(10, 39, 39, 991), account.created_at);
